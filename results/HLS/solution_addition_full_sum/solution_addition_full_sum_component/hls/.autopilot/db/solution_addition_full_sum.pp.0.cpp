# 1 "/home/joe/Desktop/Uni/Year_4/Dissertation/Program-Synthesis-for-Efficient-ML/results/cpp/solution_addition_full_sum.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/joe/Desktop/Uni/Year_4/Dissertation/Program-Synthesis-for-Efficient-ML/results/cpp/solution_addition_full_sum.cpp" 2
...
# 2 "/home/joe/Desktop/Uni/Year_4/Dissertation/Program-Synthesis-for-Efficient-ML/results/cpp/solution_addition_full_sum.cpp" 2
...
ap_uint<8> normalise_addition(ap_uint<5> raw_sum, ap_uint<4> target_exp) {
  ...
  if (s5 > 7 || s5 < -8) {
    ...
    ap_int<6> sgn = (t >= 0) ? (ap_int<6>)1 : (ap_int<6>)-1;
    t = t + sgn;
    t >>= 1;
    if (t > 7) t = 7; if (t < -8) t = -8;
    mant = (ap_int<4>)t;
...
__attribute__((sdx_kernel("add_full_sum", 0))) ap_uint<8> add_full_sum(ap_uint<4> m1, ap_uint<4> e1, ap_uint<4> m2, ap_uint<4> e2) {
#line 6 "/home/joe/Desktop/Uni/Year_4/Dissertation/Program-Synthesis-for-Efficient-ML/results/HLS/solution_addition_full_sum/hls.tcl"
#pragma HLSDIRECTIVE TOP name=add_full_sum
# 65 "/home/joe/Desktop/Uni/Year_4/Dissertation/Program-Synthesis-for-Efficient-ML/results/cpp/solution_addition_full_sum.cpp"
