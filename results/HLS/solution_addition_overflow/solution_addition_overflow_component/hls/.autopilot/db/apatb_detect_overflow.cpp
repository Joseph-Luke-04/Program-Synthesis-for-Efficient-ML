...
// wrapc file define:
#define AUTOTB_TVIN_raw_sum "../tv/cdatafile/c.detect_overflow.autotvin_raw_sum.dat"
#define AUTOTB_TVOUT_raw_sum "../tv/cdatafile/c.detect_overflow.autotvout_raw_sum.dat"
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.detect_overflow.autotvout_ap_return.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_return "../tv/rtldatafile/rtl.detect_overflow.autotvout_ap_return.dat"
...
extern "C"
void detect_overflow_hw_stub_wrapper(hls::sim::Byte<1>*, hls::sim::Byte<1>*);

extern "C"
void apatb_detect_overflow_hw(hls::sim::Byte<1>* ap_return, hls::sim::Byte<1>* __xlx_apatb_param_raw_sum)
{
  ...
  try {
    ...
    detect_overflow_hw_stub_wrapper(ap_return, __xlx_apatb_param_raw_sum);
