...
// wrapc file define:
#define AUTOTB_TVIN_raw_sum "../tv/cdatafile/c.normalise_addition.autotvin_raw_sum.dat"
#define AUTOTB_TVOUT_raw_sum "../tv/cdatafile/c.normalise_addition.autotvout_raw_sum.dat"
#define AUTOTB_TVIN_target_exp "../tv/cdatafile/c.normalise_addition.autotvin_target_exp.dat"
#define AUTOTB_TVOUT_target_exp "../tv/cdatafile/c.normalise_addition.autotvout_target_exp.dat"
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.normalise_addition.autotvout_ap_return.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_return "../tv/rtldatafile/rtl.normalise_addition.autotvout_ap_return.dat"
...
extern "C"
void normalise_addition_hw_stub_wrapper(hls::sim::Byte<1>*, hls::sim::Byte<1>*, hls::sim::Byte<1>*);

extern "C"
void apatb_normalise_addition_hw(hls::sim::Byte<1>* ap_return, hls::sim::Byte<1>* __xlx_apatb_param_raw_sum, hls::sim::Byte<1>* __xlx_apatb_param_target_exp)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_raw_sum),
#endif
  };
  port1.param = __xlx_apatb_param_raw_sum;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_target_exp),
#endif
  };
  port2.param = __xlx_apatb_param_target_exp;
  ...
  try {
    ...
    normalise_addition_hw_stub_wrapper(ap_return, __xlx_apatb_param_raw_sum, __xlx_apatb_param_target_exp);
