...
extern "C"
void naive_int_add_hw_stub_wrapper(hls::sim::Byte<1>*, hls::sim::Byte<1>*, hls::sim::Byte<1>*);

extern "C"
void apatb_naive_int_add_hw(hls::sim::Byte<1>* ap_return, hls::sim::Byte<1>* __xlx_apatb_param_x, hls::sim::Byte<1>* __xlx_apatb_param_y)
{
