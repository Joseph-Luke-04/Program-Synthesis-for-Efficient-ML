...
ap_uint<32> fp32_sum(ap_uint<1> s1, ap_uint<8> e1, ap_uint<23> m1, ap_uint<1> s2, ap_uint<8> e2, ap_uint<23> m2) {
  ...
  return (ap_uint<32>)s1 << 31 | (ap_uint<32>)((ap_uint<31>)(_let_5 == 0 ? (ap_uint<8>)  0 : ap_uint<8>((e1 + exp_delta_from_raw(_let_2 - (ap_uint<25>)(e1 > e2 ? (ap_uint<24>)  _let_1 : (ap_uint<24>)  _let_3))))) << 23 | (ap_uint<31>)__smt2c_ext_1);
}
