...
ap_uint<32> fp32_sum(ap_uint<1> s1, ap_uint<8> e1, ap_uint<23> m1, ap_uint<1> s2, ap_uint<8> e2, ap_uint<23> m2) {
  ...
  bool _let_6 = e1 > e2;
  ap_uint<8> _let_7 = _let_6 ? ap_uint<8>((e1 - e2)) : ap_uint<8>((e2 - e1));
  ...
  bool _let_18 = (_let_14 ? ap_uint<25>((ap_uint<25>((_let_17 + _let_9)))) : (ap_uint<25>)  (_let_17 > _let_16 ? (ap_uint<25>)  _let_11 : (ap_uint<25>)  _let_10)) == 0;
  ap_uint<24> __smt2c_src_0 = norm24_from_raw(_let_15);
  ap_uint<23> __smt2c_ext_1 = ((ap_uint<24>)__smt2c_src_0).range(22, 0);
  return (ap_uint<32>)((_let_14 ? (ap_uint<25>)  _let_13 : (ap_uint<25>)  (_let_12 ? ap_uint<25>((_let_5 - (ap_uint<25>)_let_16)) : (ap_uint<25>)  _let_10)) == 0 ? (ap_uint<1>)  0 : (ap_uint<1>)  (_let_14 ? (ap_uint<1>)  s1 : (ap_uint<1>)  (_let_12 ? (ap_uint<1>)  (_let_3 ? (ap_uint<1>)  s1 : (ap_uint<1>)  s2) : (ap_uint<1>)  (_let_3 ? (ap_uint<1>)  s2 : (ap_uint<1>)  s1)))) << 31 | (ap_uint<32>)((ap_uint<31>)(_let_18 ? (ap_uint<8>)  0 : ap_uint<8>(((_let_3 ? (ap_uint<8>)  e1 : (ap_uint<8>)  e2) + exp_delta_from_raw(_let_15)))) << 23 | (ap_uint<31>)(_let_18 ? (ap_uint<23>)  0 : (ap_uint<23>)  __smt2c_ext_1));
}
