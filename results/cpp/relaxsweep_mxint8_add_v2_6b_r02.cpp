...
ap_uint<8> add_full_sum(ap_uint<4> m1, ap_uint<4> e1, ap_uint<4> m2, ap_uint<4> e2) {
  ...
  return (ap_uint<8>)__smt2c_ext_3 << 4 | (ap_uint<8>)(_let_6 + _let_6 == 0 ? (ap_uint<4>)  0 : (ap_uint<4>)  sat_mant4(norm_shifted5(_let_6 + (ap_uint<5>)(ap_int<5>)(ap_int<4>)__smt2c_ext_7)));
}
