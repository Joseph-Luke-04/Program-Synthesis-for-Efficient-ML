...
ap_uint<8> add_full_sum(ap_uint<4> m1, ap_uint<4> e1, ap_uint<4> m2, ap_uint<4> e2) {
  ...
  return (ap_uint<8>)(_let_7 + (ap_uint<5>)(ap_int<5>)(ap_int<4>)((ap_int<4>)e1 > (ap_int<4>)e2 ? (ap_uint<4>)  m1 : (ap_uint<4>)  m2) == 0 ? (ap_uint<4>)  0 : (ap_uint<4>)  clamp_exp4(_let_2 + exp_delta5_from_raw(_let_7 + (ap_uint<5>)(ap_int<5>)(ap_int<4>)__smt2c_ext_3))) << 4 | (ap_uint<8>)__smt2c_ext_7;
}
