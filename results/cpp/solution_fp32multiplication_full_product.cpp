...
ap_uint<32> fp32_full_mul(ap_uint<32> a, ap_uint<32> b) {
  ...
  return (ap_uint<32>)(__smt2c_ext_2 ^ __smt2c_ext_3) << 31 | (ap_uint<32>)((ap_uint<31>)fp32_mult_exp(__smt2c_ext_4, __smt2c_ext_5, _let_3, 0) << 23 | (ap_uint<31>)fp32_mult_mant(_let_2, _let_1, _let_3));
}
