...
ap_uint<1> mult_renorm_flag(ap_uint<4> m1, ap_uint<4> m2) {
  ...
  return (ap_int<8>)(_let_1 + (_let_1 & _let_1 + _let_1)) <= (ap_int<8>)0 ? (ap_uint<1>)  1 : (ap_uint<1>)  0;
}

ap_uint<4> mult_mxint_exp(ap_uint<4> e1, ap_uint<4> e2, ap_uint<1> renorm_flag) {
  ap_uint<4> _let_1 = e1 + e1;
  bool _let_2 = renorm_flag == 1;
...
ap_uint<4> mult_mxint_mant(ap_uint<4> m1, ap_uint<4> m2) {
  ap_uint<8> _let_1 = (ap_uint<8>)(ap_int<8>)(ap_int<4>)m1 * (ap_uint<8>)(ap_int<8>)(ap_int<4>)m2;
  ap_uint<8> __smt2c_src_0 = _let_1 + _let_1;
  ap_uint<4> __smt2c_ext_1 = ((ap_uint<8>)__smt2c_src_0).range(7, 4);
  ap_uint<8> __smt2c_src_2 = (ap_uint<8>)(ap_int<8>)(ap_int<4>)__smt2c_ext_1;
