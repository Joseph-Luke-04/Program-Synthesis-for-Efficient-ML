...
ap_uint<32> fp32_full_mul(ap_uint<32> a, ap_uint<32> b) {
  ...
  ap_uint<48> __smt2c_src_7 = _let_2 == 1 ? (ap_uint<48>)((ap_uint<48>)  _let_1 >> 1) : (ap_uint<48>)  _let_1;
  ...
  return (ap_uint<32>)(__smt2c_ext_3 ^ __smt2c_ext_4) << 31 | (ap_uint<32>)((ap_uint<31>)(((__smt2c_ext_5 + __smt2c_ext_6) - 127) + (ap_uint<8>)_let_2) << 23 | (ap_uint<31>)__smt2c_ext_9);
}
