...
ap_uint<32> fp32_sum(ap_uint<1> s1, ap_uint<8> e1, ap_uint<23> m1, ap_uint<1> s2, ap_uint<8> e2, ap_uint<23> m2) {
  ...
  return (ap_uint<32>)(_let_2 ? (ap_uint<1>)  s1 : (ap_uint<1>)  s2) << 31 | (ap_uint<32>)((ap_uint<31>)((e1 > e2 ? (ap_uint<8>)  e1 : (ap_uint<8>)  e2) + exp_delta_from_raw(_let_6 + (ap_uint<25>)shr24_sat(_let_5, _let_1))) << 23 | (ap_uint<31>)__smt2c_ext_1);
}
