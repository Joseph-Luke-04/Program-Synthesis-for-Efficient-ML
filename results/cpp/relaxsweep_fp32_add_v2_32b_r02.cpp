...
ap_uint<32> fp32_sum(ap_uint<1> s1, ap_uint<8> e1, ap_uint<23> m1, ap_uint<1> s2, ap_uint<8> e2, ap_uint<23> m2) {
  ...
  ap_uint<25> _let_8 = s1 == s2 ? (ap_uint<25>)(ap_uint<25>((_let_5 + _let_7))) : (ap_uint<25>)  (_let_4 >= _let_6 ? ap_uint<25>((_let_5 - _let_7)) : ap_uint<25>((_let_7 - _let_5)));
  bool _let_9 = e1 > e2;
  ap_uint<24> __smt2c_src_0 = norm24_from_raw(_let_8);
  ap_uint<23> __smt2c_ext_1 = ((ap_uint<24>)__smt2c_src_0).range(22, 0);
  return (ap_uint<32>)(_let_9 ? (ap_uint<1>)  s1 : (ap_uint<1>)  s2) << 31 | (ap_uint<32>)((ap_uint<31>)((_let_9 ? (ap_uint<8>)  e1 : (ap_uint<8>)  e2) + exp_delta_from_raw(_let_8)) << 23 | (ap_uint<31>)__smt2c_ext_1);
}
