...
<<<<<<< Updated upstream
  ap_uint<5> __smt2c_src_2 = renorm_flag == 1 ? (ap_uint<5>)((ap_uint<5>)  _let_1 - (ap_uint<5>)(ap_int<5>)(ap_int<4>)1) : (ap_uint<5>)  _let_1;
=======
  ap_uint<5> __smt2c_src_2 = renorm_flag == 1 ? (ap_uint<5>)  _let_1 - (ap_uint<5>)(ap_int<5>)(ap_int<4>)1 : (ap_uint<5>)  _let_1;
>>>>>>> Stashed changes
