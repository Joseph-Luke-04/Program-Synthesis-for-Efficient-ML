...
ap_uint<8> mult_mxint_full_product(ap_uint<4> m1, ap_uint<4> e1, ap_uint<4> m2, ap_uint<4> e2, ap_uint<1> renorm_flag) {
  ...
  ap_uint<8> __smt2c_src_0 = (ap_uint<8>)((ap_int<8>)_let_2 >> (ap_int<8>)(((ap_int<8>)((ap_int<8>)_let_2 < (ap_int<8>)0 ? (ap_uint<8>)((ap_uint<8>)  -_let_2) : (ap_uint<8>)  _let_2) <= (ap_int<8>)31 ? (ap_uint<1>)  1 : (ap_uint<1>)  0) == 1 ? (ap_uint<8>)  2 : (ap_uint<8>)  3));
