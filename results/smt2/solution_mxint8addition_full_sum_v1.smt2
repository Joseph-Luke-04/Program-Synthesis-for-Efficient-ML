...
(define-fun add_full_sum ((m1 (_ BitVec 4)) (e1 (_ BitVec 4)) (m2 (_ BitVec 4)) (e2 (_ BitVec 4))) (_ BitVec 8) (let ((_let_1 ((_ sign_extend 1) e1))) (let ((_let_2 ((_ sign_extend 1) e2))) (let ((_let_3 (bvsge e1 e2))) (let ((_let_4 ((_ sign_extend 1) (ite _let_3 m1 m2)))) (concat ((_ extract 3 0) (bvadd ((_ sign_extend 1) (ite _let_3 e2 e1)) (exp_delta5_from_raw (bvadd ((_ sign_extend 1) (ite _let_3 m2 m1)) ((_ sign_extend 1) (ite (= e1 e2) m2 m1)))))) (ite (= _let_4 #b00000) #b0000 (sat_mant4 (norm_shifted5 (bvadd _let_4 ((_ sign_extend 1) ((_ extract 3 0) (bvashr ((_ sign_extend 1) (ite (bvsgt e1 e2) m1 m2)) (ite _let_3 (bvsub _let_1 _let_2) (bvsub _let_2 _let_1)))))))))))))))