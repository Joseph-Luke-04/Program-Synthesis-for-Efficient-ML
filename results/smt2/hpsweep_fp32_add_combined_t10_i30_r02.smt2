...
(define-fun fp32_sum ((s1 (_ BitVec 1)) (e1 (_ BitVec 8)) (m1 (_ BitVec 23)) (s2 (_ BitVec 1)) (e2 (_ BitVec 8)) (m2 (_ BitVec 23))) (_ BitVec 32) (let ((_let_1 (concat #b1 m1))) (let ((_let_2 (concat #b1 m2))) (let ((_let_3 (bvuge e1 e2))) (let ((_let_4 (bvadd ((_ zero_extend 1) (ite _let_3 _let_1 _let_2)) ((_ zero_extend 1) (shr24_sat (ite _let_3 _let_2 _let_1) (bvsub e1 e2)))))) (concat s1 (concat (bvadd (ite (bvugt e1 e2) e1 e2) (exp_delta_from_raw _let_4)) ((_ extract 22 0) (norm24_from_raw _let_4)))))))))