...
(define-fun fp32_sum ((s1 (_ BitVec 1)) (e1 (_ BitVec 8)) (m1 (_ BitVec 23)) (s2 (_ BitVec 1)) (e2 (_ BitVec 8)) (m2 (_ BitVec 23))) (_ BitVec 32) (let ((_let_1 (concat #b1 m1))) (let ((_let_2 (concat #b1 m2))) (let ((_let_3 (bvugt e1 e2))) (let ((_let_4 ((_ zero_extend 1) (ite _let_3 _let_2 _let_1)))) (let ((_let_5 ((_ zero_extend 1) (ite _let_3 _let_1 _let_2)))) (concat s1 (concat (bvadd (ite _let_3 e1 e2) (exp_delta_from_raw (bvadd _let_5 _let_4))) ((_ extract 22 0) (bvsub _let_5 _let_4))))))))))