...
(define-fun fp32_sum ((s1 (_ BitVec 1)) (e1 (_ BitVec 8)) (m1 (_ BitVec 23)) (s2 (_ BitVec 1)) (e2 (_ BitVec 8)) (m2 (_ BitVec 23))) (_ BitVec 32) (let ((_let_1 (concat #b1 m2))) (let ((_let_2 (concat #b1 m1))) (let ((_let_3 (bvuge e1 e2))) (let ((_let_4 (ite _let_3 _let_2 _let_1))) (let ((_let_5 ((_ zero_extend 1) _let_4))) (let ((_let_6 (ite _let_3 _let_1 _let_2))) (let ((_let_7 ((_ zero_extend 1) _let_6))) (let ((_let_8 (ite (= s1 s2) (bvadd _let_5 _let_7) (ite (bvuge _let_4 _let_6) (bvsub _let_5 _let_7) (bvsub _let_7 _let_5))))) (let ((_let_9 (bvugt e1 e2))) (concat (ite _let_9 s1 s2) (concat (bvadd (ite _let_9 e1 e2) (exp_delta_from_raw _let_8)) ((_ extract 22 0) (norm24_from_raw _let_8))))))))))))))