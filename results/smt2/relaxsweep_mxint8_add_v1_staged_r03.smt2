...
(define-fun add_full_sum ((m1 (_ BitVec 4)) (e1 (_ BitVec 4)) (m2 (_ BitVec 4)) (e2 (_ BitVec 4))) (_ BitVec 8) (let ((_let_1 ((_ sign_extend 1) #b0010))) (let ((_let_2 (bvsgt e1 e2))) (let ((_let_3 (bvsge e1 e2))) (let ((_let_4 ((_ sign_extend 1) (ite _let_3 m2 m1)))) (let ((_let_5 ((_ sign_extend 1) (ite _let_3 m1 m2)))) (concat ((_ extract 3 0) (bvadd ((_ sign_extend 1) (ite _let_2 e1 e2)) (exp_delta5_from_raw (bvadd _let_5 (bvadd _let_4 _let_1))))) (ite (= _let_5 #b00000) #b0000 (sat_mant4 (norm_shifted5 (bvadd _let_4 (bvadd ((_ sign_extend 1) (ite _let_2 m1 m2)) _let_1))))))))))))