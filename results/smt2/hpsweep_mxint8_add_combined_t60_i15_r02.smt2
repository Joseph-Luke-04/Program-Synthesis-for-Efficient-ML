...
(define-fun add_full_sum ((m1 (_ BitVec 4)) (e1 (_ BitVec 4)) (m2 (_ BitVec 4)) (e2 (_ BitVec 4))) (_ BitVec 8) (let ((_let_1 (bvsgt e1 e2))) (let ((_let_2 ((_ sign_extend 1) (ite _let_1 m2 m1)))) (let ((_let_3 (bvadd ((_ sign_extend 1) (ite (bvsge e1 e2) m1 m2)) _let_2))) (concat (ite (= _let_3 #b00000) #b0000 (sat_mant4 (norm_shifted5 _let_3))) ((_ extract 3 0) (bvadd ((_ sign_extend 1) (ite _let_1 e1 e2)) (exp_delta5_from_raw (bvadd ((_ sign_extend 1) (ite _let_1 m1 m2)) _let_2)))))))))