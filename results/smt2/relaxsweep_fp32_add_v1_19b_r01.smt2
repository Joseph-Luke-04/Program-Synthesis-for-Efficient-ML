...
(define-fun fp32_sum ((s1 (_ BitVec 1)) (e1 (_ BitVec 8)) (m1 (_ BitVec 23)) (s2 (_ BitVec 1)) (e2 (_ BitVec 8)) (m2 (_ BitVec 23))) (_ BitVec 32) (let ((_let_1 (concat #b1 m1))) (let ((_let_2 ((_ zero_extend 1) _let_1))) (let ((_let_3 ((_ zero_extend 1) (concat #b1 m2)))) (let ((_let_4 (bvsub _let_2 _let_3))) (concat s1 (concat (ite (= _let_4 #b0000000000000000000000000) #b00000000 (bvadd e2 (exp_delta_from_raw _let_4))) ((_ extract 22 0) (norm24_from_raw (ite (= s1 s2) (bvadd _let_3 ((_ zero_extend 1) (shr24_sat _let_1 (bvsub e2 e1)))) (ite (bvuge _let_1 _let_1) _let_4 (bvsub _let_2 _let_2))))))))))))