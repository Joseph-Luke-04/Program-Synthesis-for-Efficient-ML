...
(define-fun fp32_sum ((s1 (_ BitVec 1)) (e1 (_ BitVec 8)) (m1 (_ BitVec 23)) (s2 (_ BitVec 1)) (e2 (_ BitVec 8)) (m2 (_ BitVec 23))) (_ BitVec 32) (let ((_let_1 (concat #b1 m2))) (let ((_let_2 (concat #b1 m1))) (let ((_let_3 (bvuge e1 e2))) (let ((_let_4 (ite _let_3 _let_2 _let_1))) (let ((_let_5 ((_ zero_extend 1) _let_4))) (let ((_let_6 (bvugt e1 e2))) (let ((_let_7 (ite _let_6 (bvsub e1 e2) (bvsub e2 e1)))) (let ((_let_8 (shr24_sat (ite _let_3 _let_1 _let_2) _let_7))) (let ((_let_9 ((_ zero_extend 1) _let_8))) (let ((_let_10 (bvsub _let_9 _let_5))) (let ((_let_11 (bvsub _let_5 _let_9))) (let ((_let_12 (bvuge _let_4 _let_8))) (let ((_let_13 (bvadd _let_5 _let_9))) (let ((_let_14 (= s1 s2))) (let ((_let_15 (ite _let_14 _let_13 (ite _let_12 _let_11 _let_10)))) (let ((_let_16 (shr24_sat (ite _let_6 _let_1 _let_2) _let_7))) (let ((_let_17 (ite _let_6 _let_2 _let_1))) (let ((_let_18 (= (ite _let_14 (bvadd ((_ zero_extend 1) _let_17) _let_9) (ite (bvugt _let_17 _let_16) _let_11 _let_10)) #b0000000000000000000000000))) (concat (ite (= (ite _let_14 _let_13 (ite _let_12 (bvsub _let_5 ((_ zero_extend 1) _let_16)) _let_10)) #b0000000000000000000000000) #b0 (ite _let_14 s1 (ite _let_12 (ite _let_3 s1 s2) (ite _let_3 s2 s1)))) (concat (ite _let_18 #b00000000 (bvadd (ite _let_3 e1 e2) (exp_delta_from_raw _let_15))) (ite _let_18 #b00000000000000000000000 ((_ extract 22 0) (norm24_from_raw _let_15))))))))))))))))))))))))