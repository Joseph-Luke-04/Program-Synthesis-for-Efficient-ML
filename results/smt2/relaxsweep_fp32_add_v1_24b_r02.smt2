...
(define-fun fp32_sum ((s1 (_ BitVec 1)) (e1 (_ BitVec 8)) (m1 (_ BitVec 23)) (s2 (_ BitVec 1)) (e2 (_ BitVec 8)) (m2 (_ BitVec 23))) (_ BitVec 32) (let ((_let_1 (concat #b1 m1))) (let ((_let_2 ((_ zero_extend 1) _let_1))) (let ((_let_3 (concat #b1 m2))) (let ((_let_4 ((_ zero_extend 1) _let_3))) (let ((_let_5 (bvsub _let_2 _let_4))) (let ((_let_6 (bvuge _let_1 _let_3))) (let ((_let_7 (ite _let_6 _let_5 (bvsub _let_4 _let_2)))) (let ((_let_8 (= s1 s2))) (let ((_let_9 (bvadd _let_2 _let_2))) (let ((_let_10 (bvuge e1 e2))) (concat (ite (= _let_9 #b0000000000000000000000000) #b0 (ite _let_8 s1 (ite _let_6 (ite _let_10 s1 s2) (ite _let_10 s2 s1)))) (concat (ite (= _let_5 #b0000000000000000000000000) #b00000000 (bvadd e1 (exp_delta_from_raw (ite _let_8 _let_9 _let_7)))) ((_ extract 22 0) (norm24_from_raw (ite _let_8 (bvadd _let_2 _let_4) _let_7))))))))))))))))