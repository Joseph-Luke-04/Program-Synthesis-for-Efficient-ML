...
(define-fun add_full_sum ((m1 (_ BitVec 4)) (e1 (_ BitVec 4)) (m2 (_ BitVec 4)) (e2 (_ BitVec 4))) (_ BitVec 8) (let ((_let_1 (bvsge e1 e2))) (let ((_let_2 ((_ sign_extend 1) (ite _let_1 e1 e2)))) (let ((_let_3 (bvsub _let_2 ((_ sign_extend 1) (ite _let_1 e2 e1))))) (let ((_let_4 ((_ sign_extend 1) (ite _let_1 m2 m1)))) (let ((_let_5 ((_ sign_extend 1) (ite _let_1 m1 m2)))) (concat (ite (= (bvadd _let_5 ((_ sign_extend 1) (ite (bvsgt e1 e2) m1 m2))) #b00000) #b0000 (clamp_exp4 (bvadd _let_2 (exp_delta5_from_raw (bvadd _let_5 ((_ sign_extend 1) ((_ extract 3 0) (bvashr _let_4 _let_3)))))))) (ite (= (bvadd _let_5 _let_5) #b00000) #b0000 (sat_mant4 (norm_shifted5 (bvadd _let_5 ((_ sign_extend 1) ((_ extract 3 0) (bvashr (bvadd _let_4 ((_ sign_extend 1) ((_ extract 3 0) _let_3))) _let_3))))))))))))))