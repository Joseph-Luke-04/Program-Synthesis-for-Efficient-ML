...
(define-fun fp32_sum ((s1 (_ BitVec 1)) (e1 (_ BitVec 8)) (m1 (_ BitVec 23)) (s2 (_ BitVec 1)) (e2 (_ BitVec 8)) (m2 (_ BitVec 23))) (_ BitVec 32) (let ((_let_1 (concat #b1 m1))) (let ((_let_2 ((_ zero_extend 1) _let_1))) (let ((_let_3 (bvsub _let_2 _let_2))) (let ((_let_4 (concat #b1 m2))) (let ((_let_5 (bvuge _let_1 _let_1))) (let ((_let_6 (bvadd _let_2 _let_2))) (let ((_let_7 (= s1 s2))) (concat s1 (concat (ite (= (ite _let_7 _let_6 (ite _let_5 (bvsub _let_2 ((_ zero_extend 1) _let_4)) _let_3)) #b0000000000000000000000000) #b00000000 (bvadd e1 (exp_delta_from_raw (ite _let_7 _let_6 (ite _let_5 (bvsub _let_2 ((_ zero_extend 1) (ite (bvugt e1 e2) _let_1 _let_4))) _let_3))))) ((_ extract 22 0) _let_1)))))))))))