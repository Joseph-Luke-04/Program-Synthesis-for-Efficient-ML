...
(define-fun add_full_sum ((m1 (_ BitVec 4)) (e1 (_ BitVec 4)) (m2 (_ BitVec 4)) (e2 (_ BitVec 4))) (_ BitVec 8) (let ((_let_1 (bvsgt e1 e2))) (let ((_let_2 (bvsge e1 e2))) (let ((_let_3 ((_ sign_extend 1) (ite _let_2 m1 m2)))) (let ((_let_4 ((_ sign_extend 1) (ite _let_1 e1 e2)))) (concat (ite (= (bvadd _let_3 _let_3) #b00000) #b0000 (sat_mant4 (norm_shifted5 (bvadd ((_ sign_extend 1) (ite _let_2 m2 m1)) ((_ sign_extend 1) ((_ extract 3 0) (bvashr _let_3 (bvsub _let_4 ((_ sign_extend 1) (ite _let_2 e2 e1)))))))))) ((_ extract 3 0) (bvadd _let_4 (exp_delta5_from_raw (bvadd _let_3 ((_ sign_extend 1) (ite _let_1 m1 m2))))))))))))