...
unsigned char add_full_sum(ap_uint<4> m1, ap_uint<4> e1, ap_uint<4> m2, ap_uint<4> e2) {
  ...
  ap_uint<5> _let_4 = _let_3 ? (ap_uint<5>)  _let_1 - _let_2 : (ap_uint<5>)  _let_2 - _let_1;
  ...
  return (unsigned char)__smt2c_ext_2 << 4 | (unsigned char)(_let_6 == 0 ? (ap_uint<4>)  0 : (ap_uint<4>)  sat_mant4(norm_shifted5(_let_6 + (ap_uint<5>)(ap_int<5>)(ap_int<4>)__smt2c_ext_4)));
}
