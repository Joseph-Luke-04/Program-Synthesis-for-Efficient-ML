...
unsigned char add_full_sum(ap_uint<4> m1, ap_uint<4> e1, ap_uint<4> m2, ap_uint<4> e2) {
  ...
  ap_uint<5> __smt2c_src_1 = (ap_uint<5>)((ap_int<5>)((ap_uint<5>)(ap_int<5>)(ap_int<4>)(_let_1 ? (ap_uint<4>)  m2 : (ap_uint<4>)  m1) + (ap_uint<5>)(ap_int<5>)(ap_int<4>)__smt2c_ext_0) >> (ap_int<5>)_let_3);
  ap_uint<4> __smt2c_ext_2 = ((ap_uint<5>)__smt2c_src_1).range(3, 0);
  ap_uint<5> _let_5 = _let_4 + (ap_uint<5>)(ap_int<5>)(ap_int<4>)__smt2c_ext_2;
  ap_uint<5> __smt2c_src_3 = _let_2 + exp_delta5_from_raw(_let_5);
  ap_uint<4> __smt2c_ext_4 = ((ap_uint<5>)__smt2c_src_3).range(3, 0);
  return (unsigned char)__smt2c_ext_4 << 4 | (unsigned char)(_let_4 + _let_4 == 0 ? (ap_uint<4>)  0 : (ap_uint<4>)  sat_mant4(norm_shifted5(_let_5)));
}
