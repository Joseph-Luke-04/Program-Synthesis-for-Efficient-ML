...
unsigned char add_full_sum(ap_uint<4> m1, ap_uint<4> e1, ap_uint<4> m2, ap_uint<4> e2) {
  ...
  ap_uint<5> _let_7 = (ap_uint<5>)(ap_int<5>)(ap_int<4>)(_let_1 ? (ap_uint<4>)  m1 : (ap_uint<4>)  m2) + (ap_uint<5>)(ap_int<5>)(ap_int<4>)((ap_int<5>)_let_3 >= (ap_int<5>)4 ? (ap_uint<4>)  0 : (ap_uint<4>)  (_let_3 == 0 ? (ap_uint<4>)  _let_6 : (ap_uint<4>)  __smt2c_ext_2));
