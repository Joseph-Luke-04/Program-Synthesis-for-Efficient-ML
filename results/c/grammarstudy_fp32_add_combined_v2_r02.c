ap_uint<24> shr24_sat(ap_uint<24> x, unsigned char d) {
...
ap_uint<24> norm24_from_raw(ap_uint<25> raw) {
  ...
  unsigned short int __smt2c_ext_19 = ((ap_uint<25>)raw).range(15, 0);
  ...
  unsigned char __smt2c_ext_35 = ((ap_uint<25>)raw).range(7, 0);
...
unsigned char exp_delta_from_raw(ap_uint<25> raw) {
  ap_uint<1> __smt2c_ext_0 = ((ap_uint<25>)raw).range(24, 24);
...
unsigned int fp32_sum(ap_uint<1> s1, unsigned char e1, ap_uint<23> m1, ap_uint<1> s2, unsigned char e2, ap_uint<23> m2) {
  ap_uint<24> _let_1 = (ap_uint<24>)1 << 23 | (ap_uint<24>)m2;
  ap_uint<24> _let_2 = (ap_uint<24>)1 << 23 | (ap_uint<24>)m1;
  __CPROVER_bool _let_3 = e1 >= e2;
  ap_uint<24> _let_4 = _let_3 ? (ap_uint<24>)  _let_2 : (ap_uint<24>)  _let_1;
  ap_uint<25> _let_5 = (ap_uint<25>)_let_4;
  __CPROVER_bool _let_6 = e1 > e2;
  unsigned char _let_7 = _let_6 ? (unsigned char)  e1 - e2 : (unsigned char)  e2 - e1;
  ap_uint<24> _let_8 = shr24_sat(_let_3 ? (ap_uint<24>)  _let_1 : (ap_uint<24>)  _let_2, _let_7);
  ap_uint<25> _let_9 = (ap_uint<25>)_let_8;
  ap_uint<25> _let_10 = _let_9 - _let_5;
  ap_uint<25> _let_11 = _let_5 - _let_9;
  __CPROVER_bool _let_12 = _let_4 >= _let_8;
  ap_uint<25> _let_13 = _let_5 + _let_9;
  __CPROVER_bool _let_14 = s1 == s2;
  ap_uint<25> _let_15 = _let_14 ? (ap_uint<25>)  _let_13 : (ap_uint<25>)  (_let_12 ? (ap_uint<25>)  _let_11 : (ap_uint<25>)  _let_10);
  ap_uint<24> _let_16 = shr24_sat(_let_6 ? (ap_uint<24>)  _let_1 : (ap_uint<24>)  _let_2, _let_7);
  ap_uint<24> _let_17 = _let_6 ? (ap_uint<24>)  _let_2 : (ap_uint<24>)  _let_1;
  __CPROVER_bool _let_18 = (_let_14 ? (ap_uint<25>)  (ap_uint<25>)_let_17 + _let_9 : (ap_uint<25>)  (_let_17 > _let_16 ? (ap_uint<25>)  _let_11 : (ap_uint<25>)  _let_10)) == 0;
  ap_uint<24> __smt2c_src_0 = norm24_from_raw(_let_15);
  ap_uint<23> __smt2c_ext_1 = ((ap_uint<24>)__smt2c_src_0).range(22, 0);
  return (unsigned int)((_let_14 ? (ap_uint<25>)  _let_13 : (ap_uint<25>)  (_let_12 ? (ap_uint<25>)  _let_5 - (ap_uint<25>)_let_16 : (ap_uint<25>)  _let_10)) == 0 ? (ap_uint<1>)  0 : (ap_uint<1>)  (_let_14 ? (ap_uint<1>)  s1 : (ap_uint<1>)  (_let_12 ? (ap_uint<1>)  (_let_3 ? (ap_uint<1>)  s1 : (ap_uint<1>)  s2) : (ap_uint<1>)  (_let_3 ? (ap_uint<1>)  s2 : (ap_uint<1>)  s1)))) << 31 | (unsigned int)((ap_uint<31>)(_let_18 ? (unsigned char)  0 : (unsigned char)  (_let_3 ? (unsigned char)  e1 : (unsigned char)  e2) + exp_delta_from_raw(_let_15)) << 23 | (ap_uint<31>)(_let_18 ? (ap_uint<23>)  0 : (ap_uint<23>)  __smt2c_ext_1));
}
