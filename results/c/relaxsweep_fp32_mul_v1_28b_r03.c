unsigned int fp32_full_mul(unsigned int a, unsigned int b) {
  ...
  ap_uint<23> __smt2c_ext_9 = ((ap_uint<24>)__smt2c_ext_8).range(22, 0);
  return (unsigned int)(__smt2c_ext_3 ^ __smt2c_ext_4) << 31 | (unsigned int)((ap_uint<31>)(((__smt2c_ext_5 + __smt2c_ext_6) - 127) + (unsigned char)_let_2) << 23 | (ap_uint<31>)__smt2c_ext_9);
}
