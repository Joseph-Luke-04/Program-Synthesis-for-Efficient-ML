...
unsigned char add_full_sum(ap_uint<4> m1, ap_uint<4> e1, ap_uint<4> m2, ap_uint<4> e2) {
  ...
  ap_uint<5> __smt2c_src_0 = (ap_uint<5>)(ap_int<5>)(ap_int<4>)(_let_1 ? (ap_uint<4>)  e1 : (ap_uint<4>)  e2) + exp_delta5_from_raw(_let_2 + _let_2 + (ap_uint<5>)(ap_int<5>)(ap_int<4>)((ap_int<4>)(_let_1 ? (ap_uint<4>)  m2 : (ap_uint<4>)  m1) < (ap_int<4>)0 ? (ap_uint<4>)  -0 : (ap_uint<4>)  7));
  ap_uint<4> __smt2c_ext_1 = ((ap_uint<5>)__smt2c_src_0).range(3, 0);
  return (unsigned char)(_let_2 == 0 ? (ap_uint<4>)  0 : (ap_uint<4>)  sat_mant4(norm_shifted5(_let_2 + (ap_uint<5>)(ap_int<5>)(ap_int<4>)(e1 == e2 ? (ap_uint<4>)  m1 : (ap_uint<4>)  m2) + (ap_uint<5>)(ap_int<5>)(ap_int<4>)7))) << 4 | (unsigned char)__smt2c_ext_1;
}
