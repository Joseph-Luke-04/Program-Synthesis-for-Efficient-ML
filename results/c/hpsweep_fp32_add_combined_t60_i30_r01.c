...
unsigned int fp32_sum(ap_uint<1> s1, unsigned char e1, ap_uint<23> m1, ap_uint<1> s2, unsigned char e2, ap_uint<23> m2) {
  ...
  return (unsigned int)(_let_3 ? (ap_uint<1>)  s1 : (ap_uint<1>)  s2) << 31 | (unsigned int)((ap_uint<31>)((e1 > e2 ? (unsigned char)  e1 : (unsigned char)  e2) + exp_delta_from_raw(_let_4)) << 23 | (ap_uint<31>)__smt2c_ext_1);
}
