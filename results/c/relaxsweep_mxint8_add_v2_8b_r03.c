...
unsigned char add_full_sum(ap_uint<4> m1, ap_uint<4> e1, ap_uint<4> m2, ap_uint<4> e2) {
  ...
  return (unsigned char)__smt2c_ext_4 << 4 | (unsigned char)(_let_7 + _let_7 == 0 ? (ap_uint<4>)  0 : (ap_uint<4>)  sat_mant4(norm_shifted5(_let_7 + (ap_uint<5>)(ap_int<5>)(ap_int<4>)__smt2c_ext_6)));
}
