unsigned int fp32_full_mul(unsigned int a, unsigned int b) {
  ...
  ap_uint<24> __smt2c_ext_6 = ((ap_uint<48>)_let_1).range(47, 24);
  ap_uint<1> __smt2c_ext_7 = ((ap_uint<48>)_let_1).range(23, 23);
  ap_uint<25> __smt2c_src_8 = (ap_uint<25>)__smt2c_ext_6 + (ap_uint<25>)__smt2c_ext_7;
  ap_uint<23> __smt2c_ext_9 = ((ap_uint<25>)__smt2c_src_8).range(22, 0);
  return (unsigned int)(__smt2c_ext_2 ^ __smt2c_ext_3) << 31 | (unsigned int)((ap_uint<31>)((__smt2c_ext_4 + __smt2c_ext_5) - 126) << 23 | (ap_uint<31>)__smt2c_ext_9);
}
