ap_uint<56> fp32_aligner(unsigned char e1, ap_uint<23> m1, unsigned char e2, ap_uint<23> m2) {
  ...
  ap_uint<24> _let_3 = (ap_uint<24>)0 << 8 | (ap_uint<24>)(_let_1 ? (unsigned char)  e1 - e2 : (unsigned char)  e2 - e1);
  ap_uint<24> _let_4 = (ap_uint<24>)(e1 == 0 ? (ap_uint<1>)  0 : (ap_uint<1>)  1) << 23 | (ap_uint<24>)m1;
  return (ap_uint<56>)(_let_1 ? (ap_uint<24>)  _let_4 : (ap_uint<24>)  _let_4 >> _let_3) << 32 | (ap_uint<56>)((unsigned int)(_let_1 ? (ap_uint<24>)  _let_2 >> _let_3 : (ap_uint<24>)  _let_2) << 8 | (unsigned int)(_let_1 ? (unsigned char)  e1 : (unsigned char)  e2));
}
...
unsigned int fp32_normaliser(ap_uint<25> raw_sum_mantissa, ap_uint<1> raw_sign, unsigned char target_exponent) {
  ...
  unsigned short int __smt2c_ext_34 = ((ap_uint<25>)raw_sum_mantissa).range(15, 0);
  ...
  unsigned char __smt2c_ext_42 = ((ap_uint<25>)raw_sum_mantissa).range(7, 0);
  ...
  return (unsigned int)(_let_27 ? (ap_uint<1>)  0 : (ap_uint<1>)  raw_sign) << 31 | (unsigned int)((ap_uint<31>)(_let_27 ? (unsigned char)  0 : (unsigned char)  target_exponent + (_let_26 ? (unsigned char)  1 : (unsigned char)  (_let_25 ? (unsigned char)  0 : (unsigned char)  (_let_24 ? (unsigned char)  -1 : (unsigned char)  (_let_23 ? (unsigned char)  -2 : (unsigned char)  (_let_22 ? (unsigned char)  -3 : (unsigned char)  (_let_21 ? (unsigned char)  -4 : (unsigned char)  (_let_20 ? (unsigned char)  -5 : (unsigned char)  (_let_19 ? (unsigned char)  -6 : (unsigned char)  (_let_18 ? (unsigned char)  -7 : (unsigned char)  (_let_17 ? (unsigned char)  -8 : (unsigned char)  (_let_16 ? (unsigned char)  -9 : (unsigned char)  (_let_15 ? (unsigned char)  -10 : (unsigned char)  (_let_14 ? (unsigned char)  -11 : (unsigned char)  (_let_13 ? (unsigned char)  -12 : (unsigned char)  (_let_12 ? (unsigned char)  -13 : (unsigned char)  (_let_11 ? (unsigned char)  -14 : (unsigned char)  (_let_10 ? (unsigned char)  -15 : (unsigned char)  (_let_9 ? (unsigned char)  -16 : (unsigned char)  (_let_8 ? (unsigned char)  -17 : (unsigned char)  (_let_7 ? (unsigned char)  -18 : (unsigned char)  (_let_6 ? (unsigned char)  -19 : (unsigned char)  (_let_5 ? (unsigned char)  -20 : (unsigned char)  (_let_4 ? (unsigned char)  -21 : (unsigned char)  (_let_3 ? (unsigned char)  -22 : (unsigned char)  (_let_2 ? (unsigned char)  -23 : (unsigned char)  0)))))))))))))))))))))))))) << 23 | (ap_uint<31>)__smt2c_ext_50);
}
