unsigned char mult_mxint_full_product(ap_uint<4> m1, ap_uint<4> e1, ap_uint<4> m2, ap_uint<4> e2, ap_uint<1> renorm_flag) {
  ...
  unsigned char __smt2c_src_2 = (unsigned char)((signed char)(_let_1 + (_let_2 ? (unsigned char)  -1 : (unsigned char)  0)) >> (signed char)(renorm_flag == 1 ? (unsigned char)  3 : (unsigned char)  2));
