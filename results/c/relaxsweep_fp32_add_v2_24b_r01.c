...
unsigned int fp32_sum(ap_uint<1> s1, unsigned char e1, ap_uint<23> m1, ap_uint<1> s2, unsigned char e2, ap_uint<23> m2) {
  ...
  ap_uint<25> _let_4 = (ap_uint<25>)(_let_1 ? (ap_uint<24>)  _let_2 : (ap_uint<24>)  _let_3) + (ap_uint<25>)shr24_sat(_let_1 ? (ap_uint<24>)  _let_3 : (ap_uint<24>)  _let_2, _let_1 ? (unsigned char)  e1 - e2 : (unsigned char)  e2 - e1);
