...
unsigned char align_mantissas(ap_uint<4> m1, ap_uint<4> e1, ap_uint<4> m2, ap_uint<4> e2) {
  ...
  return (unsigned char)(_let_1 ? (ap_uint<4>)  _let_2 : (ap_uint<4>)  __smt2c_ext_2) << 4 | (unsigned char)(_let_1 ? (ap_uint<4>)  ((ap_int<5>)_let_3 >= (ap_int<5>)4 ? (ap_uint<4>)  0 : (ap_uint<4>)  __smt2c_ext_4) : (ap_uint<4>)  _let_2);
}

ap_uint<9> add_raw(ap_uint<4> m1, ap_uint<4> e1, ap_uint<4> m2, ap_uint<4> e2) {
  unsigned char _let_1 = align_mantissas(m1, e1, m2, e2);
...
unsigned char normalise_addition(ap_uint<5> raw_sum, ap_uint<4> target_exp) {
  ...
  __CPROVER_bool _let_2 = raw_sum == 0;
  ...
  ap_uint<5> __smt2c_src_6 = (ap_int<5>)_let_3 >= (ap_int<5>)0 ? (ap_uint<5>)  (ap_uint<5>)((ap_int<5>)raw_sum >> (ap_int<5>)_let_3) : (ap_uint<5>)  raw_sum << -_let_3;
  ap_uint<4> __smt2c_ext_7 = ((ap_uint<5>)__smt2c_src_6).range(3, 0);
  return (unsigned char)(_let_2 ? (ap_uint<4>)  0 : (ap_uint<4>)  __smt2c_ext_5) << 4 | (unsigned char)(_let_2 ? (ap_uint<4>)  0 : (ap_uint<4>)  __smt2c_ext_7);
}
