...
unsigned char fp32_mult_exp(unsigned char ea, unsigned char eb, ap_uint<1> renorm, ap_uint<1> carry) {
  ap_uint<10> __smt2c_src_0 = (((ap_uint<10>)(ap_int<10>)(signed char)ea + (ap_uint<10>)(ap_int<10>)(signed char)eb) - 127) + (ap_uint<10>)renorm;
...
unsigned int fp32_full_mul(unsigned int a, unsigned int b) {
  ...
  return (unsigned int)(__smt2c_ext_2 ^ __smt2c_ext_3) << 31 | (unsigned int)((ap_uint<31>)fp32_mult_exp(__smt2c_ext_4, __smt2c_ext_5, _let_3, fp32_mult_round_carry(_let_2, _let_1, _let_3)) << 23 | (ap_uint<31>)fp32_mult_mant(_let_2, _let_1, _let_3));
}
