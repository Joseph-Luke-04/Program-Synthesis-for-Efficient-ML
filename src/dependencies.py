...
DEPENDENCY_MAP = {
    ...
    "multiplication_full_product_v2": [],
    ...
    "mxint8multiplication_full_product_v2": [],
    ...
    "fp32multiplication_full_product_v2": [],
}
