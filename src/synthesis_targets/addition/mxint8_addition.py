...
class MXINT8AdditionTarget:
    ...
    def get_components(self) -> Dict:
        ...
        return {
            "alignment": {
                "template": "sygus_grammars/addition/MXINT8/mxint8_add_alignment_template.sl",
                "generator": self.gen_alignment_constraint,
            },
            "raw_sum": {
                "template": "sygus_grammars/addition/MXINT8/mxint8_add_raw_sum_template.sl",
                "generator": self.gen_raw_sum_constraint,
            },
            "overflow": {
                "template": "sygus_grammars/addition/MXINT8/mxint8_add_detect_overflow_template.sl",
                "generator": self.gen_overflow_flag_constraint,
            },
            "normalisation": {
                "template": "sygus_grammars/addition/MXINT8/mxint8_add_normalisation_template.sl",
