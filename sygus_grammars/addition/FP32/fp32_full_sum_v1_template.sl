...
; Monolithic FP32 adder baseline grammar (V1).
; Deliberately looser than the guided V2 grammar:
;   - keeps helper sketches for tractability,
;   - widens ordering, alignment, magnitude, and packing choices.
